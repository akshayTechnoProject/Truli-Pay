...
//       src: localStorage.getItem("DM_Admin_IMAGE") ? localStorage.getItem("DM_Admin_IMAGE") : '',
//       alt:''
//   });
...
//             storage.ref('admins/').child(image.name).getDownloadURL().then(url => {
...
//     if (!input['old_password'] || doc.data().password!=password.old_password) {
//       isValidPass = false;
